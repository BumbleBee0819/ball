...
public:
    ...
    virtual void Initialize()
    {
        ...
        g_buffers->positions[c3].w = 0.0f;
        g_buffers->positions[c4].w = 0.0f;
        ...
        for (int i=0; i < int(g_buffers->positions.size()); ++i)
        {
            if (i != c1 && i != c2 && i != c3 && i != c4) {
                ...
                g_buffers->positions[i].y = -0.0f + sinf(DegToRad(15.0f))*x;
                ...
                CreateSpring(c3, i, stiffness, give);
                CreateSpring(c4, i, stiffness, give);
            }
        }

        g_buffers->positions[c2].x = g_buffers->positions[c1].x + (g_buffers->positions[c2].x-g_buffers->positions[c1].x)*0.01f;
        g_buffers->positions[c3].x = g_buffers->positions[c1].x + (g_buffers->positions[c3].x-g_buffers->positions[c1].x)*0.01f;
        g_buffers->positions[c4].x = g_buffers->positions[c1].x+ (g_buffers->positions[c4].x-g_buffers->positions[c1].x)*0.01f;

        g_buffers->positions[c2].z = g_buffers->positions[c1].z + (g_buffers->positions[c2].z-g_buffers->positions[c1].z)*0.01f;
        g_buffers->positions[c3].z = g_buffers->positions[c1].z + (g_buffers->positions[c3].z-g_buffers->positions[c1].z)*0.01f;
        g_buffers->positions[c4].z = g_buffers->positions[c1].z+ (g_buffers->positions[c4].z-g_buffers->positions[c1].z)*0.01f;
        ...
        CreateParticleShape(obj,            // mesh
            Vec3(position_offset.x+0.1f, position_offset.y-0.7f, position_offset.z+1.0f),                    // lower
            0.7f,                           // scale
            0.0f,                           // rotation
        ...
        // CreateParticleGrid(Vec3(obj_center.x-0.5f, obj_center.y+2.0f, obj_center.z-0.5f), 
        //     10, 10, 10, 0.05f, 
        //     Vec3(0.0f,-1.0f,0.0f), 0.2f, true, 1.0f, 
    ...
    void Update() {
        ...
        float startTime = 0.6f; // <----- let cloth settle on object
